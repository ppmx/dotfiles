...
local function set_wallpaper(s)
	if beautiful.wallpaper then
		...
		if type(wallpaper) == "function" then
			...
			gears.wallpaper.centered(wallpaper, s, "#222")--, 1)
		end

		-- gears.wallpaper.maximized(wallpaper, s, true)
		--gears.wallpaper.centered(wallpaper, s, "#ffffff", 1)
	end
end
...
globalkeys = gears.table.join(
	...
	awful.key(
		{modkey, }, "s", function () awful.util.spawn("/home/mx/scripts/scrot") end
	),
	...
	awful.key({ modkey, }, "x", function () awful.spawn("/home/mx/bin/screenlock") end, {description = "lock the screen", group = "launcher"}),
